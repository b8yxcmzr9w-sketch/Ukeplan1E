...
-- ── 9. multi_day_events ─────────────────────────────────────────
-- auth_role() = 'kontaktlaerer' er fortsatt gyldig (kontaktlærere
-- beholder sin basisrolle etter 018). Admin-armen utvides.
...
-- ── 11. pending_transfers (admin-slett) ─────────────────────────
